/**
 * This file is to handle unwanted console.log
 * It is important to call this file at the beginning of the application
 */
var console = ( function ( oldCons ) { 
    ...
    let drop = false;
    let newCons = { ...oldCons };
    window.console = oldCons; // A quick handle to be able to use consoles on app. Use consol instead of console
    if ( drop ) {
        oldCons.log(
            "%c             ",
        ...
        // newCons.error = oldCons.error; // It can retain error logs if required
    }
    return newCons;
})( window.console );
